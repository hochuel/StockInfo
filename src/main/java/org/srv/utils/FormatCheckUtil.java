...
/**
 *
 * @ClassName   : FormatCheckUtil.java
 * @Description : 포맷유효성체크 에 대한 Util 클래스 (Framework - utility)
 * @author ADM기술팀
 * @since 2016. 6. 29.
 * @version 1.0
 * @see
...
public class FormatCheckUtil {
     ...
     * 
     * 
     * @param   tell1 전화번호 문자열
     * @param   tell2 전화번호 문자열
     * @param   tell3 전화번호 문자열
     ...
     * 
     * 
     * @param   cell1 휴대폰번호 문자열
     * @param   cell2 휴대폰번호 문자열
     * @param   cell3 휴대폰번호 문자열
