...
/**
 *
 * @ClassName   : NumberCheckUtil.java
 * @Description : 번호유효성체크 에 대한 Util 클래스 (Framework - utility)
 * @author ADM기술팀
 * @since 2016. 6. 29.
 * @version 1.0
 * @see
...
public class NumberCheckUtil {
     ...
     * 
     * 
     * @param   bubin1 6자리 법인앞번호 문자열
     * @param   bubin2 7자리 법인뒷번호 문자열
     ...
     *     
     * 
     * @param   comp1 3자리 사업자앞번호 문자열
     * @param   comp2 2자리 사업자중간번호 문자열
     * @param   comp3 5자리 사업자뒷번호 문자열
     ...
     *      
     * 
     * @param   foreign1 6자리 외국인등록앞번호 문자열
     * @param   foreign2 7자리 외국인등록뒷번호 문자열
     ...
     *     
     * 
     * @param   foreign 13자리 외국인등록번호 문자열
     * @return  유효한 외국인등록번호인지 여부 (True/False)
     */
